...
export class ChangeAmbulanceDetailsComponent{
  ...
  constructor(private fb: FormBuilder, private toastr: ToastrService, private http: HttpClient, private route: ActivatedRoute, private processData: GetProcessDataService, postData: PostProcessDataService) {
